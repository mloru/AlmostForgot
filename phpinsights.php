...
return [
    ...
    */
    ...
    'config' => [
        SlevomatCodingStandard\Sniffs\Classes\ForbiddenPublicPropertySniff::class => [
            'exclude' => [
                'app/Models/Database/v1/VoucherDealer.php',
                'app/Models/Database/v1/VoucherDealerPackage.php',
                'app/Models/Database/v1/VoucherCarData.php',
                'app/Events/v1/VoucherCreated.php',
                'app/Mail/v1/VoucherMail.php',
                'app/Listeners/v1/SendDataToLeader.php',
                'app/Listeners/v1/SendVoucherMail.php',
            ],
        ],
        NunoMaduro\PhpInsights\Domain\Insights\CyclomaticComplexityIsHigh::class => [
            'exclude' => [
                'app/Console/Commands/VoucherMailSender.php',
            ],
        ],
    ],
